...
RSpec.describe 'タスク管理機能', type: :system do
  ...
  before do
    ...
    @task = FactoryBot.create(:task, title: 'task', content: 'task', limit: '2020-02-01 14:48:00 +0900', priority: 1)
  end
  ...
  describe 'タスク一覧画面' do
    ...
    context '複数のタスクを作成した場合' do
      ...
      it 'タスクが優先度の高い順に並んでいること' do
        new_task = FactoryBot.create(:task, title: 'important_task', content: 'task_content', limit: '2020-03-01 14:48:00 +0900', priority: 0)
        new_task = FactoryBot.create(:task, title: 'not_important_task', content: 'task_content', limit: '2020-01-01 14:48:00 +0900',priority: 2)
